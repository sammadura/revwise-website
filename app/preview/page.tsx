        ...
        <div className="container-custom relative z-10 py-20 md:py-28">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              {/* Trust indicators */}
              <div className="mt-12 flex items-center gap-6 justify-center lg:justify-start animate-fade-in-up animation-delay-800">
                <div className="flex -space-x-2">
                  {[1, 2, 3, 4].map((i) => (
                    <div key={i} className="w-10 h-10 bg-gradient-to-br from-gray-200 to-gray-300 rounded-full border-2 border-white" />
                  ))}
                </div>
                <div className="text-left">
                  ...
                  <p className="text-sm text-white/70">Trusted by 500+ local businesses</p>
                </div>
              </div>
            </div>
